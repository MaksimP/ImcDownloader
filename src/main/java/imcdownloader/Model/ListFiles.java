...
public class ListFiles {
    ...
    static {
        ...
        list_files.put("ic_sovok.xls", "микросхемы(снг)");
        list_files.put("vt_import.xls", "транзисторы(имп)");
        list_files.put("vt_sovok.xls", "транзисторы(снг)");
        list_files.put("vd_import.xls", "диоды(имп)");
        list_files.put("vd_sovok.xls", "диоды(снг)");
        ...
        list_files.put("res_f.xls", "резисторы нелинейные, датчики");
        list_files.put("res_pot.xls", "резисторы переменные");
        list_files.put("relay.xls", "реле");
        list_files.put("qrystal.xls", "резонаторы, генераторы");
        list_files.put("inductor.xls", "индуктивности, трансформаторы");
        list_files.put("x_import.xls", "разьемы имп");
        list_files.put("x_sovok.xls", "разьемы СНГ");
        list_files.put("panelki.xls", "панельки");
        list_files.put("s_import.xls", "кнопки, выключатели имп");
        list_files.put("s_sovok.xls", "кнопки, выключатели СНГ");
        list_files.put("other.xls", "предохранители");
        list_files.put("pribor.xls", "приборы(сов)");
        list_files.put("multimetr.xls", "измерительная техника, средства отладки, программаторы");
        ...
        list_files.put("material.xls", "материалы, макетные платы");
